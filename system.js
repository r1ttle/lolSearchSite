...
function enterkey(element, API_KEY) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.ajax({
                method: "GET",
                url: "https://cors0327.herokuapp.com/https://asia.api.riotgames.com/lol/match/v5/matches/by-puuid/" + result.puuid + "/ids?start=0&count=20&api_key=" + API_KEY,
                ...
                .done(function (msg) {
                    ...
                    for (IDX = 0; IDX < 10; IDX++) {
                        ...
                        $.ajax({
                            method: "GET",
                            url: "https://cors0327.herokuapp.com/https://asia.api.riotgames.com/lol/match/v5/matches/" + msg[IDX] + "?api_key=" + API_KEY,
