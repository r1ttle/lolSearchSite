...
function enterkey(element) {
    ...
    $.ajax({
        ...
        .done(function (msg) {
            ...
            $.ajax({
                method: "GET",
                url: "https://cors0327.herokuapp.com/https://kr.api.riotgames.com/lol/match/v4/matchlists/by-account/" + msg.accountId + "?api_key=RGAPI-5c96ae2e-82d4-4c7e-b7ca-329fd661ef0b",
